...
var InputItem = function (_React$Component) {
    ...
    InputItem.prototype.render = function render() {
        ...
        var textStyle = {
            width: 4 * _variables2["default"].grid * labelNumber
        };
        var inputStyle = {
            color: error ? '#f50' : _variables2["default"].neutral_10
        };
        var extraStyle = {
            width: typeof extra === 'string' && extra.length > 0 ? extra.length * 4.5 * _variables2["default"].grid : 0
        };
        return React.createElement(
            ...
            React.createElement(_reactNative.TextInput, { style: [_index2["default"].input, inputStyle], value: value, keyboardType: format === 'number' || format === 'bankCard' ? 'numeric' : 'default', onChange: function onChange(event) {
                    return _this2.onChange(event.nativeEvent.text);
                }, onFocus: function onFocus() {
                    return _this2.props.onFocus();
                }, onBlur: function onBlur() {
                    return _this2.props.onBlur();
                }, placeholder: placeholder, autoCorrect: false, secureTextEntry: format === 'password', clearButtonMode: clear ? 'while-editing' : 'never', editable: editable }),
