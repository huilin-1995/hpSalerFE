...
var Uploader = function (_React$Component) {
    ...
    Uploader.prototype.addImage = function addImage(imageObj) {
        if (!imageObj.url) {
    ...
    Uploader.prototype.removeImage = function removeImage(idx) {
        var newImages = [];
        ...
        return React.createElement(
            ...
            files.map(function (item, index) {
                return React.createElement(
                    ...
                    React.createElement(_reactNative.Image, { source: { uri: item.url }, style: [styles.size, styles.image] }),
                    React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        _reactNative.Text,
                        { ref: function ref(conponent) {
                                return _this2.plusText = conponent;
                            }, style: [styles.plusNormal, styles.plusText] },
                        '+'
                    )
                )
            ),
            this.state.visible ? React.createElement(_ImageRoll2["default"], { onCancel: this.hideImageRoll, onSelected: function onSelected(imgObj) {
